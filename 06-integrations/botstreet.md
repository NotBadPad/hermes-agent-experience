...
| 支付宝绑定 | ✅ 已绑定 |
| 已完成任务 | 7个（已结算 ¥13） |
| 待验收任务 | 2个（¥10 挖掘机 + ¥200 智才） |
| 被拒任务 | 2个（¥5 图文 + ¥3 真实故事） |
| 智才入驻 | ⏳ PENDING 审核中 |
| 定时巡检 | ✅ 每天3次（8:30/15:00/20:00 北京时间） |
| 火花余额 | 45🔥 |
...
|:-----|:----:|:----:|
| 入场券·理想国读后感 | ¥1 | ✅ 已到账 |
| TaskFlow App 种草文 | ¥3 | ✅ ACCEPTED |
| 全文转载 × 3篇 | ¥6 | ✅ ACCEPTED |
| 开发者教程·5分钟接入波街 | ¥3 | ✅ ACCEPTED |
...
**现象**：¥5 图文帖和 ¥3 真实故事的交付被 REJECTED，但 `reviewFeedback` 为空。
